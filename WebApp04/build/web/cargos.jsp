...
<html>
   ...
   <h1>Listado de Tabla Cargos</h1>
        ...
        <tr>
            ...
            <td style='text-align:center;width:100px;font-weight: bold;'>CARGO</td>
            <td style='text-align:center;width:100px;font-weight: bold;'>ESTADO</td>
        </tr>
        <%
        while( rs.next() ) {
           out.print("<tr>");
