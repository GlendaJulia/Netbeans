    ...
    <div class="summaryColumn" >
        ...
        <table id="orderSummaryTable" class="detailsTable">
            ...
            <tr class="tableHeading">
                <td><fmt:message key="producto"/></td>
        ...
        <table id="deliveryAddressTable" class="detailsTable">
            ...
            <tr>
                <td colspan="3" class="lightBlue">
                    ...
                    ${customer.direccion}
                    <br>
                    <fmt:message key="prague"/> ${customer.CiudadRegion}
                    <br>
                    <hr>
                    <strong><fmt:message key="email"/>:</strong> ${customer.correo}
                    <br>
                    <strong><fmt:message key="phone"/>:</strong> ${customer.telefono}
                </td>
            </tr>
        </table>
    </div>
