<%-- 
    Document   : alumno
    Created on : 06/09/2018, 04:04:13 PM
    Author     : USER
--%>
...
HttpSession misession= (HttpSession) request.getSession();
  ...
  String id_alumno= (String) misession.getAttribute("id_alumno");
if(misession == null){
...
<%
  ...
  String sql = "select * from cursos where Codigo_usuario='"+id_alumno+"'";
...
table#editar td {
    ...
    <body bgcolor=pink>
        ...
        <h2>Listado de Cursos del alumno <b><% out.print(usuario); %></b></h2>
        <table id="listado">
        <tr>
            <td style='text-align:center;width:250px;font-weight: bold;'>NOMBRE</td>
            <td style='text-align:center;width:100px;font-weight: bold;'>NOTAS</td></tr>
        <%
        while( rs.next() ) {
           out.print("<tr>");
